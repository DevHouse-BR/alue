            ...
            <div class="row blog-post-row">
                <div class="span12 blog-post-span">
                  <?php if ( !is_archive() ) { ?>
                        ...
                        <?php } ?> 
                        <?php if (!(have_posts())) { ?><div class="span12"><h2 class="colored">Nenhum registro encontrado.</h2></div><?php }  ?>   
                    ...
                    <div class="blog-post-box">
                        ...
                        <div class="post-meta">
                            ...
                            <a href="#"><?php echo get_the_date('d M y'); ?></a>
                             <?php comments_popup_link('0 comentários', '1 comentário', '% comentários','comments-link','COs comentários estão desligados para este post'); ?>
                        </div>
                        <!-- post meta end -->
