            ...
            <div class="row single-blog-post-row">
                ...
                <div class="row <?php post_class(); ?>" id="post-<?php the_ID(); ?>">
               		<div class="blog-post-box">
                        ...
                        <!-- post meta -->
                        <div class="post-meta">
                            <a class="autor" href="#">por <?php the_author() ?></a> 
                            <a href="#"><?php echo get_the_date('d M y'); ?></a>
                             <?php comments_popup_link('0 comentários', '1 comentário', '% comentários','comments-link','Os comentários estão desligados para este post'); ?>
                             <?php the_category(', ') ?>
                         </div>
  						<!-- post meta end -->
                      ...
                      <!-- post tags -->
					  <div class="post-tags">Tags:  <?php $tag = get_the_tags(); if (! $tag) { ?> Não há tags<?php } else { ?><?php the_tags(''); ?><?php } ?></div>
					  <!-- post tags -->
